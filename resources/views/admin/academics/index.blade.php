...
<div class="app-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <a href="{{ route('admin.academics.add') }}" target="_blank" rel="noopener noreferrer"
                ...
                <table id="example" class="display" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $academic->icon }}</td>
                            <td>@if (!empty($academic->image))
                                <a href="{{ asset('storage/' . $academic->image) }}" target="_blank"
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.academics.destroy', $academic->id) }}"
                                    class="btn btn-danger btn-sm delete-confirm" data-id="{{ $academic->id }}">
                                    Delete
                                </a>
                            </td>
                        </tr>
