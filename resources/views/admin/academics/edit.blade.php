...
@section('title', 'Academics Admin | Home | Edit')
@section('content')
                ...
                <div class="container-fluid d-flex justify-content-center">
                    <div class="card w-100">
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('admin.academics.update', $academics->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" rows="3" placeholder="Description"
                                        required>  {{$academics->description}}</textarea>
                                </div>
