...
@section('title', 'Academics Admin | Admissions')
...
<div class="app-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <a href="{{ route('admin.admissions.add') }}" target="_blank" rel="noopener noreferrer"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.admissions.destroy', $admission->id) }}"
                                    class="btn btn-danger btn-sm delete-confirm" data-id="{{ $admission->id }}">
                                    Delete
                                </a>
                            </td>
                        </tr>
