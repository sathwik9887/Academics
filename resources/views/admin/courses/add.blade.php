                            ...
                            <form action="{{ route('admin.courses.store') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="courseHeading" class="form-control"
                                        placeholder="Course Heading" required>
                                </div>
                                <br>
                                <div class="form-group">
                                    <label for="courseText">Course Text</label>
                                    <input type="text" name="courseText" class="form-control" placeholder="Course Text"
                                        required>
                                </div>
                                <br>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="rating" class="form-control" placeholder="Course Rating"
                                        required>
                                </div>
                                <br>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" name="endDuration" class="form-control"
                                        placeholder="Course End Duration" required>
                                </div>
                                <br>
                                <div class="form-group">
