...
@section('title', 'Academics Admin | About')
...
<div class="app-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <a href="{{ route('admin.about.add') }}" target="_blank" rel="noopener noreferrer"
                ...
                <table id="example" class="display" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.about.show', $detail->id) }}"
                                    class="btn btn-info btn-sm">View</a>
                                <a href="{{ route('admin.about.edit', $detail->id) }}"
                                    class="btn btn-warning btn-sm">Edit</a>
                                <a href="{{ route('admin.about.destroy', $detail->id) }}"
